      ...
      <div className="container mx-auto px-4 py-8 sm:py-10 md:py-12">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6 sm:gap-8 mb-8 sm:mb-12">
          ...
          <div className="col-span-2 md:col-span-1">
            ...
            <p className="text-xl font-black text-[#064e3b] uppercase tracking-tighter mb-2">EDUSMART SN</p>
            <p className="text-sm font-bold text-[#10b981] uppercase tracking-[0.2em] mb-4">Smarter Education</p>
